...
<div class="container mt-5">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" value="{{ $properties->first()->title }}" readonly>
    </div>
@else
...
@endif
    ...
    <div class="d-flex">
        ...
        <a href="{{ route('properties.show', request()->get('property_id')) }}" class="btn btn-secondary">Back</a>
