...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Property::class, 'property_user', 'user_id', 'property_id')->withTimestamps();
    }
...
public function rentedProperties()
{
    return $this->hasManyThrough(Property::class, Contract::class, 'tenant_id', 'id', 'id', 'property_id');
}
